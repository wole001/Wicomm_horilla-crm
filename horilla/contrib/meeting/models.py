...
class MeetingLink(HorillaCoreModel):
    """
    A generated / manually created meeting link that can be attached to any
    object (e.g. a lead, activity, or calendar event).
    """
    ...
    class Meta:
        """Meta for MeetingLink."""

        verbose_name = _("Meeting Link")
        verbose_name_plural = _("Meeting Links")
