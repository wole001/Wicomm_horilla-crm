"""
Tests for the Horilla _inherit extension system.
"""
...
class ExtensionMetaclassTests(SimpleTestCase):
    ...
    def test_invalid_inherit_format_raises(self):
        """_inherit must use app_label.ModelName syntax."""
        with self.assertRaises(ValueError):
            type(
                "BadExtension",
                (HorillaCoreModel,),
                {
                    "_inherit": "invalid-no-dot",
